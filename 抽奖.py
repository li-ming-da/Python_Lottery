...
label1 = tk.Label(root, text='免所有作业', bg='yellow', font=('Arial', 20))
label1.place(x=5, y=5, width=200, height=200)

label2 = tk.Label(root, text='啥也没有', bg='yellow', font=('Arial', 20))
label2.place(x=210, y=5, width=200, height=200)

label3 = tk.Label(root, text='免一半作业', bg='yellow', font=('Arial', 20))
...
label5 = tk.Label(root, text='啥也没有', bg='yellow', font=('Arial', 20))
label5.place(x=415, y=415, width=200, height=200)

label6 = tk.Label(root, text='给一个人\n加一项作业', bg='yellow', font=('Arial', 20))
label6.place(x=210, y=415, width=200, height=200)

label7 = tk.Label(root, text='再来一次', bg='yellow', font=('Arial', 20))
label7.place(x=5, y=415, width=200, height=200)

label8 = tk.Label(root, text='免四分之一作业', bg='yellow', font=('Arial', 20))
